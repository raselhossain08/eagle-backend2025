...
// Export the schema for use in other models if needed
module.exports = { signedContractSchema };

// Note: The actual SignedContract model is exported from contract.model.js to avoid duplication
